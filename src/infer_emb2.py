...
#/home/repos/gnani_lre/trell/hin_IN/b8cded16b02de3c7bece4fa64b794e01560096f8_apiservice_20201130160732215437.wav
...
# logistic regression
parser.add_argument('--logistic_regression', default="/home/repos/VGG-Speaker-Recognition/result/telugu-hindi-bengali/logistic_regression", type=str)
parser.add_argument('--mean', default='/home/repos/VGG-Speaker-Recognition/result/telugu-hindi-bengali/mean.vec', type=str)
parser.add_argument('--lda', default='/home/repos/VGG-Speaker-Recognition/result/telugu-hindi-bengali/transform.mat', type=str)
parser.add_argument('--langs', default="/home/repos/VGG-Speaker-Recognition/result/telugu-hindi-bengali/langs", type=str)
global args
...
ki = xopen(args.logistic_regression)
